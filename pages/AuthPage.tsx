        ...
        {step === 'create-account' && (
          <div className="space-y-5 sm:space-y-6 w-full max-w-md">
            ...
            <button
              ...
              className="w-full py-3.5 sm:py-4 bg-white border-2 border-gray-200 text-[#15383c] font-bold rounded-full shadow-sm hover:shadow-md hover:border-[#e35e25] transition-all flex items-center justify-center gap-3 touch-manipulation text-sm sm:text-base"
            >
