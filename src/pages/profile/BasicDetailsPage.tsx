      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-6">
           ...
           <div className="space-y-2">
              ...
              <textarea rows={4} defaultValue="Discover & host events in your neighborhood. Join experiences to learn, create, and connect with people nearby." className="w-full bg-white border border-gray-200 rounded-3xl py-4 px-6 text-[#15383c] focus:outline-none focus:border-[#15383c] transition-all resize-none" />
           </div>
           <div className="pt-8">
