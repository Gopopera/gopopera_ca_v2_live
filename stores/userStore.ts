...
interface UserStore {
  ...
  addRSVP: (userId: string, eventId: string, options?: { attendeeCount?: number; supportContribution?: number; paymentMethod?: string; totalAmount?: number; paymentIntentId?: string; subscriptionId?: string; pricingMode?: 'free' | 'online' | 'door'; attendeePhone?: string }) => Promise<string>; // Returns reservation ID
...
export const useUserStore = create<UserStore>()(
  persist(
    (set, get) => ({
      ...
      addRSVP: async (userId: string, eventId: string, options?: { attendeeCount?: number; supportContribution?: number; paymentMethod?: string; totalAmount?: number; paymentIntentId?: string; subscriptionId?: string; pricingMode?: 'free' | 'online' | 'door'; attendeePhone?: string }): Promise<string> => {
        try {
